...
export default function Header() {
  ...
  const handleLogout = async (event) => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_ENDPOINTS}/auth/logout`,
        {
          method: "POST",
          headers: {
  ...
  return (
    <Container color={theme.colors.gray200}>
      <Notice
        isopen={isOpen_notice}
        bgcolor={theme.colors.gray900}
      ...
      <DContainer>
        <NavBar>
          ...
          <LinkDiv>
            <Links href={"/about"} color={theme.colors.gray900}>
              {i18n.t("routes.about")}
            </Links>
            <Links href={"/workflow"} color={theme.colors.gray900}>
              {i18n.t("routes.workflow")}
            </Links>
          </LinkDiv>
          <ButtonDiv>
            {!auth && (
            ...
            {auth && (
              <Menu className="dropdown">
                <ProfileMenuContainer
                  className="dropdown-toggle user-menu-combination"
                ...
                {menuopened && (
                  <MenuItem
                    className="dropdown-menu ani-acc-menu"
                    id="userdropdown"
                    role="menu"
                    bordercolor={theme.colors.gray200}
                  >
                    <Item
                      className="wo_user_name"
                      color={theme.colors.gray900}
                      bgcolor={theme.colors.white}
                      Link="/profile"
                      onClick={() => {
                    ...
                    >
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M3 4.40625C3 3.16361 4.00736 2.15625 5.25 2.15625H10.75C11.9926 2.15625 13 3.16361 13 4.40625V6.40625C13 6.82046 12.6642 7.15625 12.25 7.15625C11.8358 7.15625 11.5 6.82046 11.5 6.40625V4.40625C11.5 3.99204 11.1642 3.65625 10.75 3.65625H5.25C4.83579 3.65625 4.5 3.99204 4.5 4.40625V15.9062C4.5 16.3205 4.83579 16.6562 5.25 16.6562H10.75C11.1642 16.6562 11.5 16.3205 11.5 15.9062V13.9062C11.5 13.492 11.8358 13.1562 12.25 13.1562C12.6642 13.1562 13 13.492 13 13.9062V15.9062C13 17.1489 11.9926 18.1562 10.75 18.1562H5.25C4.00736 18.1562 3 17.1489 3 15.9062V4.40625Z"
                          fill="#6B7280"
                        />
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M6 10.1562C6 9.74204 6.33579 9.40625 6.75 9.40625H16.2955L15.2483 8.46372C14.9404 8.18663 14.9154 7.71241 15.1925 7.40453C15.4696 7.09664 15.9438 7.07168 16.2517 7.34878L18.7517 9.59878C18.9098 9.74101 19 9.94363 19 10.1562C19 10.3689 18.9098 10.5715 18.7517 10.7137L16.2517 12.9637C15.9438 13.2408 15.4696 13.2159 15.1925 12.908C14.9154 12.6001 14.9404 12.1259 15.2483 11.8488L16.2955 10.9062H6.75C6.33579 10.9062 6 10.5705 6 10.1562Z"
                          fill="#6B7280"
                        />
                      </svg>
                    </Item>
